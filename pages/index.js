        ...
        <div className="px-6 lg:px-8">
          <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-20 sm:pb-40">
            ...
            <div className="flex flex-col justify-around my-5">
              <p className="text-md flex flex-row space-x-3 justify-center items-center">
                <PhoneIcon className="h-6 w-6 text-indigo-600 mx-2" />
                +639270238375
              </p>
              <p className="text-md flex flex-row space-x-3 justify-center items-center">
                <InboxIcon className="h-6 w-6 text-indigo-600 mx-2" />
                marco.deguzman.ico@gmail.com
              </p>
            </div>
            <div>
              ...
              <p className="mt-6 leading-8 text-gray-600 sm:text-center text-md">
                ...
                in modern web technologies. My expertise lies in using Next.js,
                React.js, MongoDB, and Redux to build robust and scalable web
                applications. With a strong foundation in both front-end and
                back-end development, I excel at creating seamless and efficient
                user experiences. I am dedicated to continuous learning and
