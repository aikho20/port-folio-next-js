...
export default function Home() {
  ...
  return (
    ...
    <div className="relative h-full w-full container">
      ...
      <div className=" flex flex-col md:flex-row  min-h-screen w-100 items-center p-4 gap-4">
      ...
      <div className="flex flex-col justify-evenly md:flex-row">
        <div className="w-full flex flex-col item-start md:items-end p-4">
          ...
          <div className="flex flex-col gap-2 items-end">
            {skillSet.map((items) => (
              <div className="flex flex-col gap-2 w-full item-start md:items-end">
      ...
      <Modal isOpen={isOpen} title={"Project Details"} onClose={() => {
        close()
